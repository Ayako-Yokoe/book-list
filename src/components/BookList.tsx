...
const BookList = () => {
  ...
  return (
    <>
      <form className="bg-brown grid grid-cols-1 gap-4 md:grid-cols-2 xl:gap-14 px-4 md:px-10 lg:px-16 pb-6 md:pb-12 lg:pb-24">
      ...
      <div className="text-center m-8 md:m-12 lg:m-32">
        <h3 className="mb-6 md:mb-14 md:text-2xl lg:text-4xl">
          Your Book List
        </h3>
